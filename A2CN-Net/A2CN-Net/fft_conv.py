...
class resBottleneck1(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, groups=1, base_width=64, dilation=1, norm_layer=None, downsample=False):
        ...
        self.conv4 =  _FFTConv(in_channels=width, out_channels=width,kernel_size=3,padding= 1 ,stride = 1, groups= 1)
    ...
    def forward(self, x):
        ...
        out = self.relu(self.bn2(self.conv2(self.conv4(out))))
...
if __name__ == '__main__':
    ...
    sapa =  resBottleneck1(512, 64, stride=1, groups=1, base_width=64, dilation=1, norm_layer=None, downsample=True)
    output = sapa(input)
    print(output.shape)