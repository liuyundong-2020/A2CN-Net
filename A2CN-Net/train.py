...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/resnet50-fpn.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/1.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--device', default='6,7,4,5,3,2,1,0', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
